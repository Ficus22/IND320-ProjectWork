# streamlit_app/pages/3_STL_and_spectogram.py
...
st.set_page_config(page_title="STL & Spectrogram Analysis", layout="wide")
...
st.title(f"📊 STL Decomposition & Spectrogram for {city}")
...
with tab2:
    ...
    window_length = st.number_input("Window length (hours) - one week = 168 hours", value=24*7, step=1, key="window_length")
